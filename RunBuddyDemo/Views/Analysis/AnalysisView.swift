...
#Preview {
    ...
    @State var testQuestion = Question(city: "Gig Harbor", location: .gigHarbor, duration: "30 to 60 minutes", selectedDate: selectedDate.advanceDays(by: 1), intensity: "Interval", terrainOption: "Road", nutrition: true, kit: false)
